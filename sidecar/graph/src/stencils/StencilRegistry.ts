import mx from "mx";
const { mxStencil, mxConstants, mxUtils, mxStencilRegistry, mxCellRenderer } =
  mx;
...
class StencilRegistry {
  ...
  setGetStencil() {
    ...
    mxStencilRegistry.getStencil = (name) => {
      ...
      if (
        result == null && mxCellRenderer.defaultShapes[name] == null &&
