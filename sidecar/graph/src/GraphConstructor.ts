...
export class GraphConstructor {
  ...
  construct(container, model, renderHint, stylesheet, themes, standalone) {
    ...
    if (typeof mxVertexHandler !== 'undefined') {
      ...
      this.graphHandler.getCells = (initialCell) => {
        var cells = graphHandlerGetCells.apply(this, [initialCell])
        var newCells: any[] = []
      ...
      this.connectionHandler.createTargetVertex = (evt, source) => {
        ...
        return mxConnectionHandler.prototype.createTargetVertex.apply(this, [evt, source])
      }
          ...
          if (parent != null) {
            ...
            for (var i = 0; i < childCount; i++) {
              ...
              if (
                ...
                var deg = mxUtils.getValue(state.style, mxConstants.STYLE_ROTATION, undefined) || 0
                var box = state
